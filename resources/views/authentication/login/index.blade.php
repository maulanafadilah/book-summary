...
<div class="container h-full flex flex-col justify-center items-center px-4 bg-slate-100">
    ...
    <div class="w-full bg-white rounded-xl border border-gray-200 dark:bg-gray-800 dark:border-gray-700 mb-4">
        <div class="flex flex-col p-4">
            ...
            @endif
            <h5 class="text-xl font-bold text-gray-900 dark:text-white mt-2 mb-6">Sign in to our platform</h5>
            ...
            <div class="w-full flex justify-between mb-2">
                <h4 class="text-sm text-gray-900 font-medium">Not registered?</h4>
                <a href="/register" class="text-blue-700 hover:underline dark:text-blue-500 text-sm">Create account</a>
            </div>
